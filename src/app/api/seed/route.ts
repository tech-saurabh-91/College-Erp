...
async function seedAll() {
  ...
  // 18. Accounts
  await prisma.ledgerAccount.upsert({ where: { code: "CASH-001" }, update: {}, create: { code: "CASH-001", name: "Cash Account", type: "ASSET", balance: 500000 } })
  await prisma.ledgerAccount.upsert({ where: { code: "BANK-001" }, update: {}, create: { code: "BANK-001", name: "Bank Account - SBI", type: "ASSET", balance: 2500000 } })
  await prisma.ledgerAccount.upsert({ where: { code: "FEE-001" }, update: {}, create: { code: "FEE-001", name: "Fee Receivable", type: "ASSET", balance: 500000 } })
